...
_SEED_PRODUCTS = [
    ("Sona Masoori Rice", "బియ్యం", "Grains", "kg", "kg", 125, 40, 15, 48, 62, 8,
     ["rice", "biyyam", "బియ్యం", "chawal", "chaval", "चावल", "चांवल", "sona rice", "sona masoori"],
     {"bag": 50.0}, "Sri Balaji Wholesale"),
    ("Basmati Rice", "बासमती चावल", "Grains", "kg", "kg", 60, 20, 8, 90, 120, 3,
     ["basmati", "basmati rice", "बासमती", "बासमती चावल", "long rice"], {"bag": 25.0}, "Sri Balaji Wholesale"),
    ("Wheat Flour", "గోధుమ పిండి", "Grains", "kg", "kg", 70, 25, 10, 32, 44, 6,
     ["wheat flour", "atta", "aata", "आटा", "गेहूं", "गेहूँ", "गेहूं का आटा", "godhuma pindi", "wheat"], {"bag": 25.0}, "Sri Balaji Wholesale"),
    ("Poha", "అటుకులు", "Grains", "kg", "kg", 18, 8, 3, 40, 55, 2,
     ["poha", "पोहा", "atukulu", "flattened rice", "aval", "चूड़ा", "चिवड़ा"], {"packet": 0.5}, "Sri Balaji Wholesale"),
    ("Semolina", "బొంబాయి రవ్వ", "Grains", "kg", "kg", 2, 8, 3, 36, 48, 2,
     ["semolina", "rava", "रवा", "sooji", "suji", "सूजी", "सुजी", "ravva", "bombay rava"], {"packet": 0.5}, "Sri Balaji Wholesale"),
    ("Sugar", "చక్కెర", "Essentials", "kg", "kg", 8, 20, 10, 40, 48, 5,
     ["sugar", "cheeni", "chini", "चीनी", "shakkar", "शक्कर", "చక్కెర"], {"bag": 50.0}, "Agarwal Wholesale"),
    ("Salt", "ఉప్పు", "Essentials", "kg", "kg", 45, 10, 4, 18, 24, 2,
     ["salt", "namak", "नमक", "uppu", "ఉప్పు"], {"packet": 1.0}, "Agarwal Wholesale"),
    ("Jaggery", "బెల్లం", "Essentials", "kg", "kg", 14, 6, 2, 55, 75, 1.5,
     ["jaggery", "gud", "गुड़", "गुड", "bellam", "బెల్లం"], {"packet": 0.5}, "Agarwal Wholesale"),
    ("Toor Dal", "కంది పప్పు", "Pulses", "kg", "kg", 30, 15, 6, 110, 135, 4,
     ["toor dal", "tur dal", "तूर दाल", "तुअर दाल", "dal", "दाल", "pappu", "kandi pappu", "arhar", "अरहर"], {"bag": 30.0}, "Agarwal Wholesale"),
    ("Moong Dal", "పెసర పప్పు", "Pulses", "kg", "kg", 22, 12, 5, 120, 145, 3,
     ["moong dal", "मूंग दाल", "मूँग", "मूंग", "pesara pappu", "moong", "green dal"], {}, "Agarwal Wholesale"),
    ("Chana Dal", "శనగ పప్పు", "Pulses", "kg", "kg", 2, 10, 4, 95, 120, 3,
     ["chana dal", "चना दाल", "चना", "senaga pappu", "bengal gram", "chana"], {"bag": 30.0}, "Agarwal Wholesale"),
    ("Sunflower Oil", "నూనె", "Oils", "litre", "litre", 35, 15, 6, 130, 155, 4,
     ["oil", "sunflower oil", "सूरजमुखी तेल", "noone", "tel", "तेल", "నూనె"], {"carton": 12.0}, "Krishna Traders"),
    ("Groundnut Oil", "వేరుశనగ నూనె", "Oils", "litre", "litre", 20, 10, 4, 165, 195, 3,
     ["groundnut oil", "peanut oil", "मूंगफली तेल", "मूंगफली का तेल", "verusenaga noone", "palli oil"], {"carton": 12.0}, "Krishna Traders"),
    ("Ghee", "నెయ్యి", "Oils", "litre", "litre", 6, 4, 1.5, 480, 560, 1,
     ["ghee", "घी", "neyyi", "నెయ్యి", "clarified butter"], {"packet": 0.5}, "Krishna Traders"),
    ("Turmeric Powder", "పసుపు", "Spices", "kg", "kg", 9, 4, 1.5, 180, 220, 0.5,
     ["turmeric", "haldi", "हल्दी", "हल्दी पाउडर", "pasupu", "పసుపు"], {"packet": 0.1}, "Krishna Traders"),
    ("Chilli Powder", "కారం", "Spices", "kg", "kg", 7, 4, 1.5, 200, 250, 0.6,
     ["chilli powder", "mirchi", "मिर्च", "मिर्ची", "लाल मिर्च", "karam", "కారం", "red chilli"], {"packet": 0.1}, "Krishna Traders"),
    ("Milk", "పాలు", "Dairy", "litre", "litre", 40, 20, 8, 48, 58, 15,
     ["milk", "paalu", "doodh", "दूध", "పాలు"], {"packet": 0.5}, "Anand Dairy"),
    ("Curd", "పెరుగు", "Dairy", "kg", "kg", 12, 8, 3, 50, 70, 5,
     ["curd", "perugu", "dahi", "दही", "yogurt", "పెరుగు"], {"packet": 0.5}, "Anand Dairy"),
    ("Paneer", "పనీర్", "Dairy", "kg", "kg", 3, 5, 2, 260, 320, 2,
     ["paneer", "पनीर", "cottage cheese", "పనీర్"], {"packet": 0.2}, "Anand Dairy"),
    ("Tea", "టీ", "Beverages", "kg", "kg", 12, 5, 2, 220, 280, 1,
     ["tea", "chai", "चाय", "चाय पत्ती", "టీ"], {"packet": 0.25}, "SnackMart Distributors"),
    ("Coffee", "కాఫీ", "Beverages", "kg", "kg", 6, 4, 1.5, 380, 450, 0.8,
     ["coffee", "kaapi", "कॉफी", "काफी", "కాఫీ"], {"packet": 0.2}, "SnackMart Distributors"),
    ("Biscuits", "బిస్కెట్లు", "Snacks", "packet", "packet", 120, 40, 15, 8, 12, 20,
     ["biscuits", "biscuit", "बिस्कुट", "बिस्किट", "cookies"], {"box": 24.0, "carton": 96.0}, "SnackMart Distributors"),
    ("Namkeen Mixture", "మిక్చర్", "Snacks", "packet", "packet", 2, 20, 8, 18, 28, 6,
     ["namkeen", "नमकीन", "mixture", "मिक्सचर", "chips", "snacks"], {"box": 12.0}, "SnackMart Distributors"),
]
